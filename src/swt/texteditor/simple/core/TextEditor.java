...
public class TextEditor {
    ...
    private void setUpFileMenuReloadAction(Menu fileMenu) {
        ...
        exitItem.addSelectionListener(new FileMenuReloadSelectionListener(shell, documentAndTabManager));
    }
    ...
    private void setUpFileMenuSaveAsAction(Menu fileMenu) {
        ...
        saveAsItem.addSelectionListener(new FileMenuSaveAsSelectionListener(shell, documentAndTabManager));
    ...
    private void setUpFileMenuSaveAction(Menu fileMenu) {
        ...
        saveItem.addSelectionListener(new FileMenuSaveSelectionListener(shell, documentAndTabManager));
    }

    private void setUpFileMenuOpenAction(Menu fileMenu) {
        MenuItem openItem = new MenuItem(fileMenu, SWT.NONE);
        openItem.setText("&Open...");
        openItem.addSelectionListener(new FileMenuOpenSelectionListener(shell, documentAndTabManager));
    }

    private void setUpFileMenuNewAction(Menu fileMenu) {
        MenuItem newItem = new MenuItem(fileMenu, SWT.NONE);
        newItem.setText("&New");
        newItem.addSelectionListener(new FileMenuNewSelectionListener(shell, documentAndTabManager));
    }
}